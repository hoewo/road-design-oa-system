...
本文档介绍 NebulaAuth 系统提供的所有脚本的使用方法和场景。
...
**位置**: `guides/scripts/add-first-admin.sh`
...
**位置**: `guides/scripts/init-admin.sql`
...
**更多信息**: 参考 [系统部署与初始化](../01-system-setup.md#方法二使用-sql-脚本)
...
**位置**: `guides/scripts/register-service.sh`
...
- [系统部署与初始化](../01-system-setup.md#步骤三创建首个管理员) - 创建管理员的方法
