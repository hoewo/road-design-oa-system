...
interface ConstructionScoreEditModalProps {
...
export const ConstructionScoreEditModal = ({
  projectId,
  visible,
  currentScore,
  onCancel,
  onSuccess,
}: ConstructionScoreEditModalProps) => {
  ...
  const updateMutation = useMutation({
    mutationFn: async (score: number) => {
      await productionService.updateStageScore(projectId, 'construction', score)
    },
    onSuccess: () => {
