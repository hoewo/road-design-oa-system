...
interface PreliminaryScoreEditModalProps {
...
export const PreliminaryScoreEditModal = ({
  projectId,
  visible,
  currentScore,
  onCancel,
  onSuccess,
}: PreliminaryScoreEditModalProps) => {
  ...
  const updateMutation = useMutation({
    mutationFn: async (score: number) => {
      await productionService.updateStageScore(projectId, 'preliminary', score)
    },
    onSuccess: () => {
